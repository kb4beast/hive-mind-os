...
6. Independent-principal profiles require pinned attestations and distinct principal, credential, administrator, and trust-domain identities. Local single-operator mode remains explicit.
