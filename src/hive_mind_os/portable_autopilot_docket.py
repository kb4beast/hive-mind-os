...
PORTABLE_AUTOPILOT_CLAIMS: tuple[ClaimSpec, ...] = (
    ...
    ClaimSpec(
        ...
        state=ImplementationState.INVENTORIED,
        rationale="Evaluate independently expressed mechanisms through ADR-057 and executable tests; do not treat the unlicensed prompt as admitted design authority.",
    ),
    ClaimSpec(
        "CLM-087",
        ("SRC-025",),
