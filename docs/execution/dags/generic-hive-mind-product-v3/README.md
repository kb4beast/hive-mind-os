...
non-merge direct child of `28463ae`, changing exactly `.gitattributes`,
`ADR_INDEX.md`, this README, `manifest.json`, `verify_plan.py`, and
`tests/test_generic_dag_v3_overlay.py`. Each changed blob must differ from the
parent. ADR-069, `materialize_plan.py`, `node-contracts.json`,
