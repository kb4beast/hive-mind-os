...
| `ADR-030` | [Explorer development evaluation substrate](ADR-030-EXPLORER-DEVELOPMENT-EVALUATION-SUBSTRATE.md) | Phase 4C | proposed for independent implementation court |
