...
| `ADR-021` | [Quarantined additive Phase 2 foundation namespace](ADR-021-QUARANTINED-V2-FOUNDATION-NAMESPACE.md) | Phase 2 | implementation candidate; inactive and independently unpromoted |
