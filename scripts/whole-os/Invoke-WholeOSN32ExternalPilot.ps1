...
& $runner -Stage "n32-external-pilot" -PromptPath $prompt -Repository $Repository -StateRoot $StateRoot -Model $Model -ReasoningEffort $ReasoningEffort -ClaimScope $ClaimScope
exit $LASTEXITCODE
