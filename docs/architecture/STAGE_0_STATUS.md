...
This status is additive to ADR-002, ADR-003, and ADR-004. The authoritative exact counts and
...
| Sibling GPT pack and images | All 16 bytes preserved, validated, registered separately, and overlap-adjudicated | License/authorship and `imgo.jpg` chain of custody remain unresolved |
...
| Byte-hashed GPT manifest and formal runtime schema | Implemented with schema/truth-boundary tests | External enforcement and signed identities remain later stages |
