...
class T(unittest.TestCase):
 def test_json_closed_and_deep_frozen(self):
  p=load_match_protocol(Path("docs/benchmarks/whole-os-match-protocol.json"));self.assertEqual(set(p.entrant_recipes),{"MB0","MB1","MB2","MB3","MC0","MC1"})
 ...
 def test_bracket_track_bye_inconclusive_lease(self):
  p=load_match_protocol("docs/benchmarks/whole-os-match-protocol.json");s=BracketState(p.protocol_digest,"development","builder-component")
 ...
 def test_negative_partial_and_state_mutations_reject(self):
  ...
  p=load_match_protocol("docs/benchmarks/whole-os-match-protocol.json");m={"MB0":0};s=BracketState(p.protocol_digest,"development","builder-component",losses=m);m["MB0"]=3
